<!-- Go to Top Button -->
<a id="topButton" type="button" class="btn btn-warning btn-lg" title="Go to top" style="display: none;" href="#top"><i class="fas fa-arrow-up"></i></a>

<!-- Navigation -->
<nav id="mainNav" class="navbar navbar-expand-lg navbar-dark fixed-top">
    <div class="container">
        <a class="navbar-brand js-scroll-trigger" href="#top">@lang('messages.menu.brand')</a>
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
            <!-- Right Side Of Menu -->
            <ul id="topMenuArea" class="navbar-nav ml-auto">
